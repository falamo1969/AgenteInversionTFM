...
def AgentePPOTrain(model_name, train_data, total_timesteps=1000000, n_loops = 1, inversion = 100000, cv_cost = 0.0025, custody_cost = 0.0015, verbose = 0):
    # Creo el entorno
    ...
    for i in range(1, n_loops+1):
        ...
        model.save(f"Models/PPO_{model_name}_{i*total_timesteps}_data.model")

    if verbose > 0:
        print("Fin entrenamiento y salvando PPO_{}_{}loops".format(model_name, n_loops))
