...
model = PPO.load("Models/PPO_data.model")
...
agente_PPO_fake_pickle = {'l_total_reward': l_total_reward,
                        'l_exe_time': l_exe_time,
                        'l_n_steps': l_n_steps,
                        'l_info': l_info}

pickle.dump(agente_PPO_fake_pickle,open('./results/agente_PPO_14-05_pickle.pickle', 'wb'))
