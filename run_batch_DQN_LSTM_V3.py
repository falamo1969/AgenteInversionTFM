...
from AgentDQN_LSTM_v3 import AgentDQNLSTM
import gym
...
test_name_l = ['2008-2009_lstm_v4', '2020-2022_lstm_v4', '2012-2014_lstm_v4', '2018-2020_lstm_v4']
...
for idx, test_name in (zip(idx_l, test_name_l)):
    ...
    if TEST == True:
        ...
        # Salvo resultados
        pickle.dump(agente_DQN_LSTM_pickle,open('./results/LSTM/LSTM_'+ test_name + now.strftime("_%d-%b_%H_%M_%S")+ '.pickle', 'wb'))    
