...
def plot_result(test_name_l, result, titulo):
    ...
    for n_ax, f_name in enumerate(test_name_l):
        ...
        v3_results = pickle.load(open('./results/PPO_'+ f_name + '_pickle.pickle', 'rb'))
        v4_results = pickle.load(open('./results/PPO_'+ f_name + '_v2_pickle.pickle', 'rb'))
        ...
        axs[n_ax].plot(x, v3_results[result], label='PPO_v1')
        axs[n_ax].plot(x, v4_results[result], label='PPO_v2')
